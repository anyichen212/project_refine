...
export const Sider: React.FC<RefineLayoutSiderProps> = ({
          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: isSelected ? "#955550" : "transparent", //item hover color
                  },
                  backgroundColor: isSelected ? "#955550" : "transparent",
  ...
  const logout = isExistAuthentication && (
    <Tooltip
      title={t("buttons.logout", "Sign Out")}
      placement="right"
      disableHoverListener={!collapsed}
      arrow
    >
      ...
      >
        ...
        <ListItemText
          primary={t("buttons.logout", "Sign Out")}
          primaryTypographyProps={{
            noWrap: true,
            fontSize: "16px",
            fontWeight: "bold",
      ...
      >
        <Drawer
          ...
          sx={{
            ...
            "& .MuiDrawer-paper": {
              width: 200,
              bgcolor: "#fc9988", //mobile sider color
            },
          }}
        >
          <Box
        ...
        >
          ...
          //bottom < button
            sx={{
              ...
              color: "secondary.contrastText", // bottom < color
              textAlign: "center",
              borderRadius: 0,
              borderTop: "1px solid #ffffff1a",
              '&:hover': {
                background: '#955555' //bottom hover color
              }
            }}
            fullWidth
            size="large"
